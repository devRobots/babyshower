  ...
  return (
    <article className="flex flex-col bg-white rounded-2xl shadow-sm">
      ...
      <main className="flex flex-col gap-1 p-4">
        ...
        <span className="font-bold text-pretty">{price}€</span>
        <button className="w-full rounded-full px-4 py-2 font-bold text-sm text-[#d55873]" style={{ backgroundColor: "#efd4db" }}>
          Elegir este regalo
        </button>
      </main>
